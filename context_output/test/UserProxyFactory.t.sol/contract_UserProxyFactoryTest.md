...
- **Name**: UserProxyFactoryTest
- **Type**: Contract
- **Path**: test/UserProxyFactory.t.sol
...
### test_deployUserProxy()

- **Signature**: `test_deployUserProxy()`
- **Visibility**: public
- **Source Range**: 942:432:106
- **Details**: [function_test_deployUserProxy.md](./function_test_deployUserProxy.md)
