# Function: test_claimBribes_invalid_previous_allocation_epoch_reverts()
...
```
┌─ [0] ⚙️ FUNCTION: BribeInitiativeTest.test_claimBribes_invalid_previous_allocation_epoch_reverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
