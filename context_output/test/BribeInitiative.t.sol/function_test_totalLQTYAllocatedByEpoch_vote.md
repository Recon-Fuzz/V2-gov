# Function: test_totalLQTYAllocatedByEpoch_vote()
...
```
┌─ [0] ⚙️ FUNCTION: BribeInitiativeTest.test_totalLQTYAllocatedByEpoch_vote() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
