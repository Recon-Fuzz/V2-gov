# Function: test_totalLQTYAllocatedByEpoch_vote_same_epoch()
...
```
┌─ [0] ⚙️ FUNCTION: BribeInitiativeTest.test_totalLQTYAllocatedByEpoch_vote_same_epoch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
