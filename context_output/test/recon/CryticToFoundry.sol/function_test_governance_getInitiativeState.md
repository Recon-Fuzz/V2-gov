# Function: test_governance_getInitiativeState()
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_governance_getInitiativeState() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: private
  └─ [1] ⚙️ FUNCTION: GovernanceTargets.governance_getInitiativeState(address) (NodeID: 5)
