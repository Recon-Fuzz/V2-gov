# Function: test_governance_deployUserProxy()
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_governance_deployUserProxy() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: private
  └─ [1] ⚙️ FUNCTION: GovernanceTargets.governance_deployUserProxy() (NodeID: 5)
      💬 Args: [no args]
      👁️  Def: public
