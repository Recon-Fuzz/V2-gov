# Function: governance_depositLQTYViaPermit(uint256,struct PermitParams,bool,address)
...
- **Governance::depositLQTYViaPermit(uint256,struct PermitParams,bool,address)**
...
```
┌─ [0] ⚙️ FUNCTION: GovernanceTargets.governance_depositLQTYViaPermit(uint256,struct PermitParams,bool,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
