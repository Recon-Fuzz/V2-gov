# Function: test_governance_withdrawLQTY_simple()
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_governance_withdrawLQTY_simple() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: GovernanceTargets.governance_withdrawLQTY(uint256) (NodeID: 8)
      💬 Args: [5e18]
      👁️  Def: public
