# Function: test_governance_claimForInitiative()
...
### governance_claimForInitiative(address)

- **Kind**: internal
- **Source**: 5009:134:125
- **Link**: `test/recon/targets/GovernanceTargets.sol:GovernanceTargets:governance_claimForInitiative(address)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_governance_claimForInitiative() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: GovernanceTargets.governance_claimForInitiative(address) (NodeID: 14)
      💬 Args: [address(bribeInitiative)]
      👁️  Def: public
