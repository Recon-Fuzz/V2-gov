...
**DoubleLinkedListWrapper**: [test/DoubleLinkedList.t.sol/contract_DoubleLinkedListWrapper.md]
...
- **Details**: [function_test_insert_random.md](./function_test_insert_random.md)
...
- **Details**: [function_test_insert_atHead.md](./function_test_insert_atHead.md)
...
- **Details**: [function_test_insert_atTail.md](./function_test_insert_atTail.md)
