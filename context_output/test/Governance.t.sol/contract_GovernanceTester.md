...
- **IUserProxyFactory** [src/interfaces/IUserProxyFactory.sol/interface_IUserProxyFactory.md]
...
### MIN_GAS_TO_HOOK (inherited from Governance)

```solidity
uint256 internal constant MIN_GAS_TO_HOOK = 350_000
```

### stakingV1 (inherited from Governance)
...
### lqty (inherited from Governance)
...
### bold (inherited from Governance)
...
### EPOCH_START (inherited from Governance)
...
### EPOCH_DURATION (inherited from Governance)
...
### EPOCH_VOTING_CUTOFF (inherited from Governance)
...
### MIN_CLAIM (inherited from Governance)
...
### MIN_ACCRUAL (inherited from Governance)
...
### REGISTRATION_FEE (inherited from Governance)
...
### REGISTRATION_THRESHOLD_FACTOR (inherited from Governance)
...
### UNREGISTRATION_THRESHOLD_FACTOR (inherited from Governance)
...
### UNREGISTRATION_AFTER_EPOCHS (inherited from Governance)
...
### VOTING_THRESHOLD_FACTOR (inherited from Governance)
...
### boldAccrued (inherited from Governance)
...
### votesSnapshot (inherited from Governance)
...
### votesForInitiativeSnapshot (inherited from Governance)
...
### globalState (inherited from Governance)
...
### userStates (inherited from Governance)
...
### initiativeStates (inherited from Governance)
...
### lqtyAllocatedByUserToInitiative (inherited from Governance)
...
### registeredInitiatives (inherited from Governance)
...
### ResetInitiativeData (inherited from Governance)
...
### AllocateLQTYMemory (inherited from Governance)
...
**Signature:**
```solidity
constructor(address _lqty, address _lusd, address _stakingV1, address _bold, Configuration memory _config, address _owner, address[] memory _initiatives) Governance(_lqty,_lusd,_stakingV1,_bold,_config,_owner,_initiatives);
```

### tester_setVotesSnapshot(struct IGovernance.VoteSnapshot)

- **Signature**: `tester_setVotesSnapshot(struct IGovernance.VoteSnapshot)`
- **Visibility**: external
- **Source Range**: 1421:127:99
- **Details**: [function_tester_setVotesSnapshot_struct_IGovernance.VoteSnapshot.md](./function_tester_setVotesSnapshot_struct_IGovernance.VoteSnapshot.md)
...
### tester_setVotesForInitiativeSnapshot(address,struct IGovernance.InitiativeVoteSnapshot)

- **Signature**: `tester_setVotesForInitiativeSnapshot(address,struct IGovernance.InitiativeVoteSnapshot)`
- **Visibility**: external
- **Source Range**: 1554:245:99
- **Details**: [function_tester_setVotesForInitiativeSnapshot_address_struct_IGovernance.InitiativeVoteSnapshot.md](./function_tester_setVotesForInitiativeSnapshot_address_struct_IGovernance.InitiativeVoteSnapshot.md)
...
### tester_setBoldAccrued(uint256)

- **Signature**: `tester_setBoldAccrued(uint256)`
- **Visibility**: external
- **Source Range**: 1805:105:99
- **Details**: [function_tester_setBoldAccrued_uint256.md](./function_tester_setBoldAccrued_uint256.md)
...
### registerInitialInitiatives(address[]) (inherited from Governance)

- **Signature**: `registerInitialInitiatives(address[])`
- **Visibility**: public
- **Source Range**: 4955:775:67
...
### depositLQTY(uint256) (inherited from Governance)

- **Signature**: `depositLQTY(uint256)`
- **Visibility**: external
- **Source Range**: 6558:111:67
...
### depositLQTY(uint256,bool,address) (inherited from Governance)

- **Signature**: `depositLQTY(uint256,bool,address)`
- **Visibility**: public
- **Source Range**: 6675:462:67
...
### depositLQTYViaPermit(uint256,struct PermitParams) (inherited from Governance)

- **Signature**: `depositLQTYViaPermit(uint256,struct PermitParams)`
- **Visibility**: external
- **Source Range**: 7175:181:67
...
### depositLQTYViaPermit(uint256,struct PermitParams,bool,address) (inherited from Governance)

- **Signature**: `depositLQTYViaPermit(uint256,struct PermitParams,bool,address)`
- **Visibility**: public
- **Source Range**: 7362:570:67
...
### withdrawLQTY(uint256) (inherited from Governance)

- **Signature**: `withdrawLQTY(uint256)`
- **Visibility**: external
- **Source Range**: 7970:112:67
...
### withdrawLQTY(uint256,bool,address) (inherited from Governance)

- **Signature**: `withdrawLQTY(uint256,bool,address)`
- **Visibility**: public
- **Source Range**: 8088:1494:67
...
### claimFromStakingV1(address) (inherited from Governance)

- **Signature**: `claimFromStakingV1(address)`
- **Visibility**: external
- **Source Range**: 9620:717:67
...
### epoch() (inherited from Governance)

- **Signature**: `epoch()`
- **Visibility**: public
- **Source Range**: 10554:125:67
...
### epochStart() (inherited from Governance)

- **Signature**: `epochStart()`
- **Visibility**: public
- **Source Range**: 10717:120:67
...
### secondsWithinEpoch() (inherited from Governance)
...
### lqtyToVotes(uint256,uint256,uint256) (inherited from Governance)

- **Signature**: `lqtyToVotes(uint256,uint256,uint256)`
- **Visibility**: public
- **Source Range**: 11045:179:67
...
### getLatestVotingThreshold() (inherited from Governance)

- **Signature**: `getLatestVotingThreshold()`
- **Visibility**: public
- **Source Range**: 11444:183:67
...
### calculateVotingThreshold() (inherited from Governance)

- **Signature**: `calculateVotingThreshold()`
- **Visibility**: public
- **Source Range**: 11665:186:67
...
### calculateVotingThreshold(uint256) (inherited from Governance)

- **Signature**: `calculateVotingThreshold(uint256)`
- **Visibility**: public
- **Source Range**: 11889:442:67
...
### getTotalVotesAndState() (inherited from Governance)

- **Signature**: `getTotalVotesAndState()`
- **Visibility**: public
- **Source Range**: 13047:518:67
...
### getInitiativeSnapshotAndState(address) (inherited from Governance)

- **Signature**: `getInitiativeSnapshotAndState(address)`
- **Visibility**: public
- **Source Range**: 14281:976:67
...
### snapshotVotesForInitiative(address) (inherited from Governance)

- **Signature**: `snapshotVotesForInitiative(address)`
- **Visibility**: external
- **Source Range**: 15295:333:67
...
### getInitiativeState(address) (inherited from Governance)

- **Signature**: `getInitiativeState(address)`
- **Visibility**: public
- **Source Range**: 16008:507:67
...
### getInitiativeState(address,struct IGovernance.VoteSnapshot,struct IGovernance.InitiativeVoteSnapshot,struct IGovernance.InitiativeState) (inherited from Governance)
...
### registerInitiative(address) (inherited from Governance)

- **Signature**: `registerInitiative(address)`
- **Visibility**: external
- **Source Range**: 19879:2024:67
...
### resetAllocations(address[],bool) (inherited from Governance)

- **Signature**: `resetAllocations(address[],bool)`
- **Visibility**: external
- **Source Range**: 24168:649:67
...
### allocateLQTY(address[],address[],int256[],int256[]) (inherited from Governance)

- **Signature**: `allocateLQTY(address[],address[],int256[],int256[])`
- **Visibility**: external
- **Source Range**: 24855:4250:67
...
### unregisterInitiative(address) (inherited from Governance)

- **Signature**: `unregisterInitiative(address)`
- **Visibility**: external
- **Source Range**: 37510:1582:67
...
### claimForInitiative(address) (inherited from Governance)

- **Signature**: `claimForInitiative(address)`
- **Visibility**: external
- **Source Range**: 39130:1970:67
