...
### (address,address,address,address,struct IGovernance.Configuration,address,address[])

- **Kind**: internal
- **Source**: 3071:1878:67
- **Link**: `src/Governance.sol:Governance:constructor(address,address,address,address,struct IGovernance.Configuration,address,address[])`
...
- **Kind**: internal
- **Source**: 4955:775:67
- **Link**: `src/Governance.sol:Governance:registerInitialInitiatives(address[])`
...
- **Kind**: internal
- **Source**: 1896:130:87
- **Link**: `src/utils/Ownable.sol:Ownable:_renounceOwnership()`
...
- **Kind**: modifier
- **Source**: 1180:103:87
- **Link**: `src/utils/Ownable.sol:Ownable:onlyOwner()`
...
- **Kind**: internal
- **Source**: 1366:90:87
- **Link**: `src/utils/Ownable.sol:Ownable:isOwner()`
...
- **Kind**: internal
- **Source**: 806:133:87
- **Link**: `src/utils/Ownable.sol:Ownable:constructor(address)`
...
- **Kind**: internal
- **Source**: 382:153:70
- **Link**: `src/UserProxyFactory.sol:UserProxyFactory:constructor(address,address,address)`
...
```
┌─ [0] 🏗️ CONSTRUCTOR: GovernanceTester.constructor(address,address,address,address,struct IGovernance.Configuration,address,address[]) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: GovernanceTester
  └─ [1] 🏗️ CONSTRUCTOR: Governance.constructor(address,address,address,address,struct IGovernance.Configuration,address,address[]) (NodeID: 1)
      💬 Args: [_lqty, _lusd, _stakingV1, _bold, _config, _owner, _initiatives]
      🏗️  Contract: Governance
    ├─ [2] ⚙️ FUNCTION: Governance.registerInitialInitiatives(address[]) (NodeID: 2)
    │   💬 Args: [_initiatives]
    │   👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: Unknown.safeCallWithMinGas(address,uint256,uint256,bytes) (NodeID: 3)
    │ │   💬 Args: [_initiatives[i], MIN_GAS_TO_HOOK, 0, abi.encodeCall(IInitiative.onRegisterInitiative, (1))]
    │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: Unknown.hasMinGas(uint256,uint256) (NodeID: 4)
    │ │     💬 Args: [_gas, 1_000]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Ownable._renounceOwnership() (NodeID: 5)
    │ │   💬 Args: [no args]
    │ │   👁️  Def: internal
    │ └─ [3] 🔒 MODIFIER: Ownable.onlyOwner() (NodeID: 6)
    │     💬 Args: [no args]
    │   └─ [4] ⚙️ FUNCTION: Ownable.isOwner() (NodeID: 7)
    │       💬 Args: [no args]
    │       👁️  Def: public
    ├─ [2] 🏗️ CONSTRUCTOR: Ownable.constructor(address) (NodeID: 8)
    │   💬 Args: [_owner]
    │   🏗️  Contract: Ownable
    └─ [2] 🏗️ CONSTRUCTOR: UserProxyFactory.constructor(address,address,address) (NodeID: 9)
