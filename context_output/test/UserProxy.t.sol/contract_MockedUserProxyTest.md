# Contract: MockedUserProxyTest

## Metadata

- **Name**: MockedUserProxyTest
- **Type**: Contract
- **Path**: test/UserProxy.t.sol
...
### lqty (inherited from UserProxyTest)
...
### lusd (inherited from UserProxyTest)
...
### stakingV1 (inherited from UserProxyTest)
...
### user (inherited from UserProxyTest)

```solidity
address internal constant user = address(0xF977814e90dA44bFA03b6295A0616a897441aceC)
```

### userProxyFactory (inherited from UserProxyTest)

```solidity
UserProxyFactory private userProxyFactory
```

**UserProxyFactory**: [src/UserProxyFactory.sol/contract_UserProxyFactory.md]

### userProxy (inherited from UserProxyTest)

```solidity
UserProxy private userProxy
```

**UserProxy**: [src/UserProxy.sol/contract_UserProxy.md]
...
### test_stake() (inherited from UserProxyTest)

- **Signature**: `test_stake()`
- **Visibility**: public
- **Source Range**: 1372:268:105
- **Details**: [function_test_stake.md](./function_test_stake.md)
...
### test_stakeViaPermit() (inherited from UserProxyTest)

- **Signature**: `test_stakeViaPermit()`
- **Visibility**: public
- **Source Range**: 1646:2057:105
- **Details**: [function_test_stakeViaPermit.md](./function_test_stakeViaPermit.md)
...
### test_unstake() (inherited from UserProxyTest)

- **Signature**: `test_unstake()`
- **Visibility**: public
- **Source Range**: 3709:797:105
- **Details**: [function_test_unstake.md](./function_test_unstake.md)
