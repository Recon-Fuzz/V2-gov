# Contract: MockedGovernanceAttacksTest

## Metadata

- **Name**: MockedGovernanceAttacksTest
- **Type**: Contract
- **Path**: test/GovernanceAttacks.t.sol
...
### lqty (inherited from GovernanceAttacksTest)
...
### lusd (inherited from GovernanceAttacksTest)
...
### stakingV1 (inherited from GovernanceAttacksTest)
...
### initialInitiatives (inherited from GovernanceAttacksTest)

```solidity
address[] private initialInitiatives
```

### maliciousInitiative1 (inherited from GovernanceAttacksTest)

```solidity
MaliciousInitiative private maliciousInitiative1
```

**MaliciousInitiative**: [test/mocks/MaliciousInitiative.sol/contract_MaliciousInitiative.md]

### maliciousInitiative2 (inherited from GovernanceAttacksTest)
...
### eoaInitiative (inherited from GovernanceAttacksTest)
...
### test_all_revert_attacks_hardcoded() (inherited from GovernanceAttacksTest)

- **Signature**: `test_all_revert_attacks_hardcoded()`
- **Visibility**: public
- **Source Range**: 3185:8415:100
- **Details**: [function_test_all_revert_attacks_hardcoded.md](./function_test_all_revert_attacks_hardcoded.md)
