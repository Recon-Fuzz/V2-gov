...
### test_initialInitiativesCanBeVotedOnAtStart()

- **Signature**: `test_initialInitiativesCanBeVotedOnAtStart()`
- **Visibility**: public
- **Source Range**: 3160:1084:98
- **Details**: [function_test_initialInitiativesCanBeVotedOnAtStart.md](./function_test_initialInitiativesCanBeVotedOnAtStart.md)
...
### test_canYouVoteWith100MLNLQTY()

- **Signature**: `test_canYouVoteWith100MLNLQTY()`
- **Visibility**: public
- **Source Range**: 4250:354:98
- **Details**: [function_test_canYouVoteWith100MLNLQTY.md](./function_test_canYouVoteWith100MLNLQTY.md)
...
### test_canYouVoteWith100MLNLQTY_after_10_years()

- **Signature**: `test_canYouVoteWith100MLNLQTY_after_10_years()`
- **Visibility**: public
- **Source Range**: 4610:667:98
- **Details**: [function_test_canYouVoteWith100MLNLQTY_after_10_years.md](./function_test_canYouVoteWith100MLNLQTY_after_10_years.md)
...
### test_noVetoGriefAtEpochOne()

- **Signature**: `test_noVetoGriefAtEpochOne()`
- **Visibility**: public
- **Source Range**: 5283:691:98
- **Details**: [function_test_noVetoGriefAtEpochOne.md](./function_test_noVetoGriefAtEpochOne.md)
...
### test_deregisterIsSound()

- **Signature**: `test_deregisterIsSound()`
- **Visibility**: public
- **Source Range**: 5980:2214:98
- **Details**: [function_test_deregisterIsSound.md](./function_test_deregisterIsSound.md)
...
### test_unregisterWorksCorrectlyEvenAfterXEpochs(uint8)

- **Signature**: `test_unregisterWorksCorrectlyEvenAfterXEpochs(uint8)`
- **Visibility**: public
- **Source Range**: 8281:2607:98
- **Details**: [function_test_unregisterWorksCorrectlyEvenAfterXEpochs_uint8.md](./function_test_unregisterWorksCorrectlyEvenAfterXEpochs_uint8.md)
...
### test_unregisterWorksCorrectlyEvenAfterXEpochs_andCanBeSavedAtLast(uint8)

- **Signature**: `test_unregisterWorksCorrectlyEvenAfterXEpochs_andCanBeSavedAtLast(uint8)`
- **Visibility**: public
- **Source Range**: 10894:2541:98
- **Details**: [function_test_unregisterWorksCorrectlyEvenAfterXEpochs_andCanBeSavedAtLast_uint8.md](./function_test_unregisterWorksCorrectlyEvenAfterXEpochs_andCanBeSavedAtLast_uint8.md)
