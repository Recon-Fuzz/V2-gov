...
```solidity
address internal constant voter = address(uint160(uint256(keccak256("voter"))))
```

### registrant

```solidity
address internal constant registrant = address(uint160(uint256(keccak256("registrant"))))
```

### initialInitiative

```solidity
address internal constant initialInitiative = address(uint160(uint256(keccak256("initialInitiative"))))
```

### newInitiative

```solidity
address internal constant newInitiative = address(uint160(uint256(keccak256("newInitiative"))))
```

### config

```solidity
IGovernance.Configuration internal config = IGovernance.Configuration({registrationFee: REGISTRATION_FEE, registrationThresholdFactor: 0.01 ether, unregistrationThresholdFactor: 4 ether, unregistrationAfterEpochs: 4, votingThresholdFactor: 0.04 ether, minClaim: 0, minAccrual: 0, epochStart: START_TIME - EPOCH_DURATION, epochDuration: EPOCH_DURATION, epochVotingCutoff: EPOCH_DURATION - 1 days})
```
...
```solidity
address[] internal initiativesToReset
```

### initiatives

```solidity
address[] internal initiatives
```

### votes

```solidity
int256[] internal votes
```

### vetos

```solidity
int256[] internal vetos
```
...
### test_AtStart_WeAreInEpoch2()

- **Signature**: `test_AtStart_WeAreInEpoch2()`
- **Visibility**: external
- **Source Range**: 3020:131:96
- **Details**: [function_test_AtStart_WeAreInEpoch2.md](./function_test_AtStart_WeAreInEpoch2.md)
...
### test_OneEpochLater_WeAreInEpoch3()

- **Signature**: `test_OneEpochLater_WeAreInEpoch3()`
- **Visibility**: external
- **Source Range**: 3157:180:96
- **Details**: [function_test_OneEpochLater_WeAreInEpoch3.md](./function_test_OneEpochLater_WeAreInEpoch3.md)
...
### test_AtStart_CanVoteOnInitialInitiative()

- **Signature**: `test_AtStart_CanVoteOnInitialInitiative()`
- **Visibility**: external
- **Source Range**: 3343:416:96
- **Details**: [function_test_AtStart_CanVoteOnInitialInitiative.md](./function_test_AtStart_CanVoteOnInitialInitiative.md)
...
### test_AtStart_CannotRegisterNewInitiative()

- **Signature**: `test_AtStart_CannotRegisterNewInitiative()`
- **Visibility**: external
- **Source Range**: 3765:166:96
- **Details**: [function_test_AtStart_CannotRegisterNewInitiative.md](./function_test_AtStart_CannotRegisterNewInitiative.md)
...
- **Details**: [function_test_OneEpochLater_WhenNoOneVotedDuringEpoch2_CanRegisterNewInitiativeWithNoLQTY.md](./function_test_OneEpochLater_WhenNoOneVotedDuringEpoch2_CanRegisterNewInitiativeWithNoLQTY.md)
...
### test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CannotRegisterNewInitiativeWithNoLQTY()

- **Signature**: `test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CannotRegisterNewInitiativeWithNoLQTY()`
- **Visibility**: external
- **Source Range**: 4136:443:96
- **Details**: [function_test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CannotRegisterNewInitiativeWithNoLQTY.md](./function_test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CannotRegisterNewInitiativeWithNoLQTY.md)
...
### test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CanRegisterNewInitiativeWithSufficientLQTY()
...
- **Details**: [function_test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CanRegisterNewInitiativeWithSufficientLQTY.md](./function_test_OneEpochLater_WhenSomeoneVotedDuringEpoch2_CanRegisterNewInitiativeWithSufficientLQTY.md)
