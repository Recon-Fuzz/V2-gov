...
```solidity
IGovernance.Configuration internal config = IGovernance.Configuration({registrationFee: 0, registrationThresholdFactor: 0, unregistrationThresholdFactor: 4 ether, unregistrationAfterEpochs: 4, votingThresholdFactor: 0, minClaim: 0, minAccrual: 0, epochStart: START_TIME - EPOCH_DURATION, epochDuration: EPOCH_DURATION, epochVotingCutoff: EPOCH_VOTING_CUTOFF})
```
...
```solidity
MockInitiative internal initiative
```

**MockInitiative**: [test/InitiativeHooks.t.sol/contract_MockInitiative.md]

### noInitiatives

```solidity
address[] internal noInitiatives
```
...
### test_OnAfterAllocateLQTY_IsCalled_WhenCastingVotes()

- **Signature**: `test_OnAfterAllocateLQTY_IsCalled_WhenCastingVotes()`
- **Visibility**: external
- **Source Range**: 3465:1045:101
- **Details**: [function_test_OnAfterAllocateLQTY_IsCalled_WhenCastingVotes.md](./function_test_OnAfterAllocateLQTY_IsCalled_WhenCastingVotes.md)
...
### test_OnAfterAllocateLQTY_IsNotCalled_WhenCastingVetos()

- **Signature**: `test_OnAfterAllocateLQTY_IsNotCalled_WhenCastingVetos()`
- **Visibility**: external
- **Source Range**: 4516:354:101
- **Details**: [function_test_OnAfterAllocateLQTY_IsNotCalled_WhenCastingVetos.md](./function_test_OnAfterAllocateLQTY_IsNotCalled_WhenCastingVetos.md)
...
### test_OnAfterAllocateLQTY_IsCalledOnceWithZeroVotes_WhenCastingVetosAfterHavingCastVotes()
...
- **Details**: [function_test_OnAfterAllocateLQTY_IsCalledOnceWithZeroVotes_WhenCastingVetosAfterHavingCastVotes.md](./function_test_OnAfterAllocateLQTY_IsCalledOnceWithZeroVotes_WhenCastingVetosAfterHavingCastVotes.md)
