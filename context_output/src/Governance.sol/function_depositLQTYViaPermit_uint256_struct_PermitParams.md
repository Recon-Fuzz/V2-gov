...
- **Kind**: internal
- **Source**: 7362:570:67
- **Link**: `src/Governance.sol:Governance:depositLQTYViaPermit(uint256,struct PermitParams,bool,address)`
...
- **Kind**: internal
- **Source**: 5915:605:67
- **Link**: `src/Governance.sol:Governance:_increaseUserVoteTrackers(uint256)`
...
- **Kind**: internal
- **Source**: 817:310:70
- **Link**: `src/UserProxyFactory.sol:UserProxyFactory:deployUserProxy()`
...
- **Kind**: internal
- **Source**: 2209:821:35
- **Link**: `lib/openzeppelin-contracts/contracts/proxy/Clones.sol:Clones:cloneDeterministic(address,bytes32)`
