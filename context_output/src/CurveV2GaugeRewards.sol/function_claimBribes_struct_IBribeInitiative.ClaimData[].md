...
**Contract**: [src/CurveV2GaugeRewards.sol/contract_CurveV2GaugeRewards.md]
...
- **Kind**: internal
- **Source**: 3602:2658:65
- **Link**: `src/BribeInitiative.sol:BribeInitiative:_claimBribe(address,uint256,uint256,uint256)`
...
- **Kind**: internal
- **Source**: 2448:122:84
- **Link**: `src/utils/DoubleLinkedList.sol:DoubleLinkedList:getItem(struct DoubleLinkedList.List,uint256)`
...
- **bribeToken** (`contract IERC20`) [lib/openzeppelin-contracts/contracts/token/ERC20/IERC20.sol/interface_IERC20.md]
