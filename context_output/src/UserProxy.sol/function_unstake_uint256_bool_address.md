...
- **Kind**: internal
- **Source**: 3735:447:69
- **Link**: `src/UserProxy.sol:UserProxy:_sendRewards(address,uint256,uint256)`
...
- **Kind**: modifier
- **Source**: 916:120:69
- **Link**: `src/UserProxy.sol:UserProxy:onlyStakingV2()`
...
- **lqty** (state variable) [lib/openzeppelin-contracts/contracts/token/ERC20/IERC20.sol/interface_IERC20.md]
