...
- **Name**: DeployUniV4MerklRewards
- **Type**: Contract
- **Path**: script/DeployUniV4MerklRewards.s.sol
...
```solidity
uint32 internal constant WEIGHT_FEES = 7500
```

### WEIGHT_TOKEN_0

```solidity
uint32 internal constant WEIGHT_TOKEN_0 = 2000
```

### WEIGHT_TOKEN_1

```solidity
uint32 internal constant WEIGHT_TOKEN_1 = 500
```
