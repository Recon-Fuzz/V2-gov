...
- **Name**: DeploySepoliaScript
- **Type**: Contract
- **Path**: script/DeploySepolia.s.sol
...
```solidity
ICurveStableswapFactoryNG private constant curveFactory = ICurveStableswapFactoryNG(address(0xfb37b8D939FFa77114005e61CFc2e543d6F49A81))
```
