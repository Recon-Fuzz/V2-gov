...
abstract contract GovernanceTargets is BaseTargetFunctions, Properties {
    ...
    function clamped_governance_allocateLQTY(
    ...
    function clamped_governance_depositLQTY(uint256 _lqtyAmount, bool _doSendRewards, address _recipient)
        public
        asActor
    {
        // Apply meaningful values from meaningful-values.json
    ...
    function clamped_governance_depositLQTYViaPermit(
        uint256 _lqtyAmount,
    ...
    function clamped_governance_withdrawLQTY(uint256 _lqtyAmount, bool _doSendRewards, address _recipient)
        public
        asActor
    {
        // Apply meaningful values from meaningful-values.json
